const titleJumbroton = document.querySelector(".jumbotron p");
titleJumbroton.innerHTML = `Kota metropolitan terbesar di Provinsi Jawa Barat, sekaligus menjadi
ibu kota provinsi tersebut.`;

const descSejarah = document.querySelector("#content #sejarah p");
descSejarah.innerHTML = `Kata Bandung berasal dari kata bendung atau bendungan karena
...
const descSejarah2 = document.querySelector("#content #sejarah .p2");
descSejarah2.innerHTML = `Berdasarkan filosofi Sunda, kata Bandung juga berasal dari kalimat
...
const descGeografis = document.querySelector("#geografis p");
descGeografis.innerHTML = `Kota Bandung dikelilingi oleh pegunungan, sehingga bentuk morfologi
...
const descGeografis2 = document.querySelector("#geografis .p2");
descGeografis2.innerHTML = `Kota Bandung dialiri dua sungai utama, yaitu Sungai Cikapundung dan
...
const descWisata = document.querySelector("#wisata p");
descWisata.innerHTML = `Sejak dibukanya Jalan Tol Cipularang, kota Bandung telah menjadi
...
const descLembang = document.querySelector("#wisata #a p");
descWisata.innerHTML = `Berada di jalur utama Bandung-Lembang, Farm House menjadi objek
...
const descBosscha = document.querySelector("#wisata #b p");
descBosscha.innerHTML = `Memiliki beberapa teleskop, antara lain, Refraktor Ganda Zeiss,
